...
const EVENTS: Array<EventSeed> = [
  {
    ...
    requirements: "Evento para mayores de 18 años. Cupos limitados.",
    priceAmount: "0",
    priceLabel: "",
  ...
  },
  {
    ...
    title: "Feria de ilustradores independientes",
    summary: "Feria de arte e ilustración con artistas emergentes.",
    description:
      "Punto Café presenta una feria de ilustradores independientes en Belgrano. Bruma Arte, Estudio Prisma y Nudo Sur exhiben obras, prints y piezas de diseño en un formato íntimo dentro del local. La propuesta combina arte visual, encuentro con creadores y consumiciones de la casa.",
    location: "Punto Café, Av. Cabildo 1999, Belgrano, CABA",
    startsAt: "2026-07-04T15:00:00-03:00",
    category: "feria_de_emprendedores",
    requirements: "Entrada libre.",
    priceAmount: "0",
    priceLabel: "",
    baseAttendanceCount: 28,
    latitude: -34.5564,
    longitude: -58.4581,
    organizerEmail: "puntocafe.eventos@gmail.com",
    organizerDisplayName: "Punto Café",
    organizerVerified: true,
    entrepreneurNames: ["Bruma Arte", "Estudio Prisma", "Nudo Sur"],
    galleryUrls: GALLERY_DEFAULTS.feria_de_emprendedores,
  },
  {
    ...
    requirements: "Materiales incluidos. Cupo limitado.",
    priceAmount: "12000",
    priceLabel: "$12.000",
  ...
  },
  {
    ...
    title: "Brunch de emprendedores",
    summary: "Encuentro para emprendedores creativos.",
    description:
      "Usina Cafetera convoca un brunch de emprendedores creativos en Belgrano. GEIESE, Sur en Dos y CRUDO participan con una propuesta de networking informal, intercambio de ideas y consumiciones de la casa en un formato distendido de domingo por la mañana.",
    location: "Usina Cafetera, Juramento 1702, Belgrano, CABA",
    startsAt: "2026-07-12T11:00:00-03:00",
    category: "feria_de_emprendedores",
    requirements: "Entrada libre.",
    priceAmount: "0",
    priceLabel: "",
    baseAttendanceCount: 24,
    latitude: -34.5596,
    longitude: -58.4518,
    organizerEmail: "usinacafetera.eventos@gmail.com",
    organizerDisplayName: "Usina Cafetera",
    organizerVerified: true,
    entrepreneurNames: ["GEIESE", "Sur en Dos", "CRUDO"],
    galleryUrls: GALLERY_DEFAULTS.gastronomia,
  },
  {
    id: "a1000017-0000-4000-8000-000000000017",
    title: "Noche de vinilos & vermú",
    summary: "DJ set con colección de vinilos y degustación de vermuts.",
    description:
      "Desarmadero Bar presenta una noche de vinilos y vermú en Palermo Hollywood. Julia Vinyl Club cura la música en formato analógico y Club del Vermú suma una propuesta de degustación para acompañar la velada en un ambiente íntimo del bar.",
    location: "Desarmadero Bar, Gorriti 4300, Palermo Hollywood, CABA",
    startsAt: "2026-07-03T21:00:00-03:00",
    category: "musica",
    requirements: "Mayores de 18 años.",
    priceAmount: "0",
    priceLabel: "",
    baseAttendanceCount: 36,
    latitude: -34.5885,
    longitude: -58.4218,
    organizerEmail: "eventos.desarmadero@gmail.com",
    organizerDisplayName: "Desarmadero Bar",
    organizerVerified: true,
    entrepreneurNames: ["Julia Vinyl Club", "Club del Vermú"],
    galleryUrls: GALLERY_DEFAULTS.musica,
  },
  {
    id: "a1000018-0000-4000-8000-000000000018",
    title: "Feria Vintage Weekend",
    summary: "Feria de moda vintage y piezas únicas con diseñadores independientes.",
    description:
      "Mercado Soho organiza una feria vintage de fin de semana en Palermo Hollywood. GEIESE, Nudo Sur, CRUDO y Sur en Dos exhiben prendas, accesorios y piezas de diseño con venta directa en un circuito pensado para descubrir moda independiente.",
    location: "Mercado Soho, Nicaragua 4583, Palermo Hollywood, CABA",
    startsAt: "2026-07-06T14:00:00-03:00",
    category: "feria_de_emprendedores",
    requirements: "Entrada libre. Venta directa en stands.",
    priceAmount: "0",
    priceLabel: "",
    baseAttendanceCount: 42,
    latitude: -34.5898,
    longitude: -58.4245,
    organizerEmail: "eventos@mercadosoho.com.ar",
    organizerDisplayName: "Mercado Soho",
    organizerVerified: true,
    entrepreneurNames: ["GEIESE", "Nudo Sur", "CRUDO", "Sur en Dos"],
    galleryUrls: GALLERY_DEFAULTS.feria_de_emprendedores,
  },
  {
  ...
  },
  {
    ...
    title: "Open Mic de artistas",
    summary: "Noche abierta para artistas emergentes con música y arte en vivo.",
    description:
      "Cuervo Café presenta un open mic para artistas emergentes en Palermo Hollywood. Bruma Arte y Estudio Prisma acompañan la velada con una propuesta que combina intervenciones en vivo, encuentro cultural y consumiciones de la casa.",
    location: "Cuervo Café, Costa Rica 5701, Palermo Hollywood, CABA",
    startsAt: "2026-07-09T20:00:00-03:00",
    category: "arte_y_cultura",
    requirements: "Entrada libre. Cupos limitados para presentaciones.",
    priceAmount: "0",
    priceLabel: "",
    baseAttendanceCount: 19,
    latitude: -34.5881,
    longitude: -58.4268,
    organizerEmail: "eventos@cuervocafe.com.ar",
    organizerDisplayName: "Cuervo Café",
    organizerVerified: true,
    entrepreneurNames: ["Bruma Arte", "Estudio Prisma"],
    galleryUrls: GALLERY_DEFAULTS.arte_y_cultura,
  },
  {
    id: "a1000022-0000-4000-8000-000000000022",
    title: "Feria de diseño independiente",
    summary: "Feria de diseño y moda independiente en Plaza Serrano.",
    description:
      "Feria Serrano organiza una jornada de diseño independiente en Plaza Serrano. GEIESE, CRUDO, Nudo Sur y Bruma Arte exhiben y venden piezas propias en un formato al aire libre con circulación de público del barrio.",
    location: "Plaza Serrano (Plaza Julio Cortázar), Palermo Soho, CABA",
    startsAt: "2026-07-13T15:00:00-03:00",
    category: "feria_de_emprendedores",
    requirements: "Entrada libre. Venta directa en stands.",
    priceAmount: "0",
    priceLabel: "",
    baseAttendanceCount: 44,
    latitude: -34.5889,
    longitude: -58.4306,
    organizerEmail: "eventos@feriaserrano.com.ar",
    organizerDisplayName: "Feria Serrano",
    organizerVerified: true,
    entrepreneurNames: ["GEIESE", "CRUDO", "Nudo Sur", "Bruma Arte"],
    galleryUrls: GALLERY_DEFAULTS.feria_de_emprendedores,
  },
  {
  ...
  },
  {
    ...
    category: "talleres_y_cursos",
    requirements: "Traer cámara o celular. Cupo limitado.",
    priceAmount: "0",
    priceLabel: "",
  ...
  },
  {
    ...
    description:
      "Plaza Italia convoca una feria gastronómica con emprendimientos locales. Club del Vermú y CRUDO participan con propuestas para degustar y descubrir sabores en un encuentro al aire libre de la zona.",
    ...
    organizerVerified: true,
    entrepreneurNames: ["Club del Vermú", "CRUDO"],
    galleryUrls: GALLERY_DEFAULTS.gastronomia,
  },
  {
  ...
  },
  {
    ...
    title: "Feria de diseño local",
    summary: "Feria de diseño y moda local en Patio Bullrich.",
    description:
      "Patio Bullrich convoca una feria de diseño local en su espacio exterior. GEIESE, Sur en Dos y Nudo Sur exhiben colecciones y piezas de autor con venta directa en un formato premium de Recoleta.",
    location: "Patio Bullrich (espacio exterior), Posadas 1245, Recoleta, CABA",
    startsAt: "2026-07-19T14:00:00-03:00",
    category: "feria_de_emprendedores",
    requirements: "Entrada libre. Venta directa en stands.",
    priceAmount: "0",
    priceLabel: "",
    baseAttendanceCount: 41,
    latitude: -34.5895,
    longitude: -58.3888,
    organizerEmail: "eventos@patiobullrich.com.ar",
    organizerDisplayName: "Patio Bullrich",
    organizerVerified: true,
    entrepreneurNames: ["GEIESE", "Sur en Dos", "Nudo Sur"],
    galleryUrls: GALLERY_DEFAULTS.feria_de_emprendedores,
  },
  {
    id: "a1000032-0000-4000-8000-000000000032",
    title: "Workshop de cerámica en Clorindo Café",
    summary: "Taller de cerámica artesanal con Tierra Taller en Recoleta.",
    description:
      "Clorindo Café y Tierra Taller convocan un workshop de cerámica en el patio del café. La propuesta incluye materiales, demostración de técnicas y espacio para crear una pieza propia en un entorno histórico de Recoleta.",
    location: "Clorindo Café, Talcahuano 1261, Recoleta, CABA",
    startsAt: "2026-07-20T17:00:00-03:00",
    category: "talleres_y_cursos",
    requirements: "No se requiere experiencia previa. Materiales incluidos. Cupo limitado.",
    priceAmount: "0",
    priceLabel: "",
    baseAttendanceCount: 23,
    latitude: -34.5926,
    longitude: -58.3934,
    organizerEmail: "eventos@clorindo.com.ar",
    organizerDisplayName: "Clorindo Café",
    organizerVerified: true,
    entrepreneurNames: ["Tierra Taller"],
    galleryUrls: GALLERY_DEFAULTS.talleres_y_cursos,
  },
  {
    ...
    category: "musica",
    requirements: "Mayores de 18 años. Cupos limitados.",
    priceAmount: "0",
    priceLabel: "",
